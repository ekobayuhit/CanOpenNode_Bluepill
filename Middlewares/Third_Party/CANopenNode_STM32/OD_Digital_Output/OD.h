...
********************************************************************************
    ...
    File info:
        ...
        Project File: GespantIO_DO_profile.xpd
        File Version: 1

        Created:      23/11/2020 13:00:00
        Created By:   
        Modified:     02/11/2025 19:27:36
        Modified By:  BES

    Device Info:
        Vendor Name:  Gespant-Winenerji
        Vendor ID:    1
        Product Name: GespantIO_DO16
        Product ID:   2
...
#define OD_CNT_Digital_Output 1
...
#define OD_ENTRY_H6200_digitalOutput &OD->list[33]
