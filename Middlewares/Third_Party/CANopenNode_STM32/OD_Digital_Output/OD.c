...
typedef struct {
    ...
    OD_obj_record_t o_6200_digitalOutput[2];
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6200_digitalOutput = {
        {
            .dataOrig = &OD_RAM.x6200_digitalOutput.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x6200_digitalOutput.value,
            .subIndex = 1,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6200, 0x02, ODT_REC, &ODObjs.o_6200_digitalOutput, NULL},
