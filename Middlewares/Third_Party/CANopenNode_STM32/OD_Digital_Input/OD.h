...
********************************************************************************
    ...
    File info:
        ...
        Project File: GespantIO_DI_profile.xdd
        File Version: 1

        Created:      23/11/2020 13:00:00
        Created By:   
        Modified:     02/11/2025 17:57:02
        Modified By:  BES

    Device Info:
        Vendor Name:  Gespant-Winenerji
        Vendor ID:    1
        Product Name: Gespant_IO
        Product ID:   1
...
#define OD_ENTRY_H6000_digitalInput &OD->list[33]
