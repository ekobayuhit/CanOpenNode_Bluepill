...
typedef struct {
    ...
    OD_obj_record_t o_6000_digitalInput[2];
} ODObjs_t;
...
static CO_PROGMEM ODObjs_t ODObjs = {
    ...
    .o_6000_digitalInput = {
        {
            .dataOrig = &OD_RAM.x6000_digitalInput.highestSub_indexSupported,
            .subIndex = 0,
            .attribute = ODA_SDO_R,
            .dataLength = 1
        },
        {
            .dataOrig = &OD_RAM.x6000_digitalInput.value,
            .subIndex = 1,
...
static OD_ATTR_OD OD_entry_t ODList[] = {
    ...
    {0x6000, 0x02, ODT_REC, &ODObjs.o_6000_digitalInput, NULL},
